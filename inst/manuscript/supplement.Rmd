...
```{r results = "asis"}
hyp %>% 
  flextable::set_caption("Table 1: Lung fibroblast fluxes in 21% and 0.5% oxygen") %>% 
...
```{r results = "asis"}
bay %>% 
  flextable::set_caption("Table 2: Lung fibroblast fluxes following DMSO and BAY treatment") %>% 
  flextable::flextable_to_rmd()
```
